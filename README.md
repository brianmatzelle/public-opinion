# About
This project aims to give users the ability to poll various open source LLMs to gain insight on public opinion from different cultures.
...
[language codes can be found here](https://py-googletrans.readthedocs.io/en/latest/)
